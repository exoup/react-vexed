...
const Gem: React.FC<GemBlockProps> = ({
  ...
  const framePath = (() => {
    let d = `M 0,-2 `;
    d += `L 24,-2 A 2,2 0 0,1 26,0 `;
    if (dragDir === 'right') d += `L 26,9 L 29,9 L 29,6 L 33,12 L 29,18 L 29,15 L 26,15 `;
    d += `L 26,24 A 2,2 0 0,1 24,26 `;
    d += `L 0,26 A 2,2 0 0,1 -2,24 `;
    if (dragDir === 'left') d += `L -2,15 L -5,15 L -5,18 L -9,12 L -5,6 L -5,9 L -2,9 `;
